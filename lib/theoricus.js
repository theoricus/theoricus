...
(function() {
  ...
  __t('theoricus.utils', window).StringUtil = (function() {
  ...
  */
  ...
  __t('theoricus.core', window).Route = (function() {
  ...
  __t('theoricus.utils', window).ObjectUtil = (function() {
  ...
  */
  ...
  __t('theoricus.core', window).Router = (function() {
    var Factory;
  ...
  __t('theoricus.utils', window).ArrayUtil = (function() {
    var ObjectUtil;
  ...
  __t('theoricus.mvc', window).Model = (function() {
  ...
  __t('theoricus.mvc', window).View = (function() {
    var Factory;
  ...
  __t('theoricus.mvc', window).Controller = (function() {
    var Factory, StringUtil;
  ...
  __t('theoricus.config', window).Config = (function() {
  ...
  __t('theoricus.core', window).Factory = (function() {
    var StringUtil;
  ...
  __t('theoricus.core', window).Processes = (function() {
  ...
  __t('theoricus', window).Theoricus = (function() {
