...
(function() {
  ...
  theoricus.mvc.View = (function() {
    ...
    View.prototype.render = function(data) {
      var aname, api, cname, dom, template;
  ...
  theoricus.mvc.Controller = (function() {
    ...
    Controller.prototype._build_action = function(process) {
      var _this = this;
      return function() {
        var action, api, ctrl, _ref;
        api = process.route.api;
        _ref = [api.controller_name, api.action_name], ctrl = _ref[0], action = _ref[1];
        return _this.view("" + ctrl + "/" + action, process).render(_this.model(ctrl));
      };
    };
    ...
    Controller.prototype.view = function(path) {
      var v;
      v = Factory.view(path);
      v.process = this.process;
      return v;
    };

    Controller.prototype.model = function(name, init) {
      var m;
  ...
  theoricus.config.Config = (function() {
    ...
    function Config(the) {
      ...
      this.the = the;
      this.app_name = "app";
      this.animate_at_startup = (_ref = app.config.animate_at_startup) != null ? _ref : false;
      this.enable_auto_transitions = (_ref1 = app.config.enable_auto_transitions) != null ? _ref1 : true;
  ...
  theoricus.core.Factory = (function() {
    ...
    Factory.prototype.model = function(name, init) {
    ...
    Factory.prototype.view = function(path) {
    ...
    Factory.prototype.template = function(path) {
  ...
  theoricus.core.Process = (function() {
    ...
    Process.prototype.run = function(after_run) {
      var action, c,
        _this = this;
      if (!(c = this.controller)[action = this.route.api.action_name]) {
        c[action] = c._build_action(this);
      }
      this.controller.process = this;
      this.view = c[action].apply(c, this.route.api.params);
      return this.view["in"](function() {
