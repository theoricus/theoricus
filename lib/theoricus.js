...
})(typeof exports === 'undefined' ? this['inflector'] = {} : exports);
...
var theoricus = window.theoricus = {'config':{},'core':{},'mvc':{},'utils':{}};
...
(function() {
  ...
  theoricus.mvc.Model = (function() {
    ...
    Model._build_gs = function(field, type) {
      ...
      _val = null;
      classname = (("" + this).match(/function\s(\w+)Model/))[1];
    ...
    Model._instantiate = function(data) {
      ...
      classname = (("" + this).match(/function\s(\w+)Model/))[1].toLowerCase();
      records = [];
      _ref = [].concat(data);
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        record = _ref[_i];
  ...
  theoricus.mvc.Fetcher = (function() {
  ...
  theoricus.mvc.View = (function() {
    ...
    View.prototype["in"] = function() {
      ...
      if (!animate) {
        return this.after_in();
      } else {
        this.el.css("opacity", 0);
        return this.el.animate({
          opacity: 1
        }, 600, function() {
          return _this.after_in();
        });
      }
    };
  ...
  theoricus.mvc.Controller = (function() {
    var Fetcher, Model, StringUtil, View, _ref;

    function Controller() {}

    Fetcher = theoricus.mvc.Fetcher;
    ...
    Controller.prototype._build_action = function(process) {
      var _this = this;
      return function() {
        var action, api, ctrl, model, model_name, _ref1;
        api = process.route.api;
        _ref1 = [api.controller_name, api.action_name], ctrl = _ref1[0], action = _ref1[1];
        model_name = (StringUtil.camelize(api.controller_name)) + "Model";
        model = app.models[model_name];
        if (model.all != null) {
          return _this.render("" + ctrl + "/" + action, model.all());
        } else {
          return _this.render("" + ctrl + "/" + action, null);
        }
      };
    };
    ...
    Controller.prototype.render = function(path, data) {
      var view;
      view = this.the.factory.view(path, this.process.route.el);
      view.process = this.process;
  ...
  theoricus.core.Factory = (function() {
    ...
    function Factory(the) {
      this.the = the;
      this.m_tmpl = "app.models.{classname}Model";
      this.v_tmpl = "app.views.{ns}.{classname}View";
    }

    Factory.model = Factory.prototype.model = function(name, init) {
      var classname, classpath, model, prop, value;
      if (init == null) {
        init = {};
      }
    ...
    Factory.prototype.view = function(path, el) {
      var classpath, klass, name, p, parts, view;
      classpath = "app.views";
      klass = app.views;
    ...
    Factory.prototype.controller = function(name) {
      var classname, classpath, controller;
  ...
  theoricus.core.Process = (function() {
    ...
    Process.prototype.run = function(after_run) {
      ...
      return this.view = this.controller[action].apply(this.controller, this.route.api.params);
    };
  ...
  theoricus.core.Processes = (function() {
    ...
    Processes.prototype._filter_pending_processes = function(process) {
      ...
      while (process && process.route.at) {
        if ((route = ArrayUtil.find(this.router.routes, {
    ...
    Processes.prototype._filter_dead_processes = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        if ((found = ArrayUtil.find(this.pending_processes, search)) != null) {
          location = found.item.route.location;
          if ((location != null) && location !== active.route.location) {
            _results.push(found = null);
          } else {
            _results.push(void 0);
          }
        } else {
