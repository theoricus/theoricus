...
(function() {
  ...
  module.exports = Cli = (function() {
    function Cli(version) {
      ...
      this.argv = ((function() {
        return this.opts = optimist.usage(this.usage).alias('n', 'new').describe('n', 'Creates a new app').alias('g', 'generate').describe('g', 'Generates a new model, view or controller').alias('d', 'destroy').describe('d', 'Destroys a new model, view, or controller').alias('s', 'start').describe('s', 'Starts app in dev mode at localhost').alias('c', 'compile').describe('c', 'Compiles app in dev mode').alias('r', 'release').describe('r', 'Releases app for production').alias('p', 'preview').describe('p', 'Releases app for production at localhost').alias('v', 'version').describe('v', 'Shows theoricus version').alias('h', 'help').describe('h', 'Shows this help screen').describe('rf', 'Use with -d [view|mvc] for deleting the whole view folder').describe('src', 'Use with -n for use a specific theoricus version as a git submodule').describe('nogitsub', 'Use with --src for avoiding automatic git submodule setup');
        /*
            NOTE FOR HACKERS:
