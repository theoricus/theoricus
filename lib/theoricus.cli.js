...
(function() {
  ...
  theoricus.commands.Compiler = (function() {
    var ArrayUtil, FsUtil, Toaster, fs, jade, nib, path, stylus;
    ...
    function Compiler(the, options) {
      ...
      config = {
        folders: {},
        vendors: ["" + this.the.root + "/www/vendors/json2.js", "" + this.the.root + "/www/vendors/jquery.js", "" + this.the.root + "/www/vendors/history.js", "" + this.the.root + "/www/vendors/history.adapter.native.js", "" + this.the.root + "/www/vendors/jade.runtime.js"],
        minify: false,
    ...
    Compiler.prototype._on_jade_stylus_change = function(info) {
      ...
      if (info.path.match(/.jade$/m)) {
        ...
        return this.compile_stylus(function(css) {
          ...
          return console.log(("Compiled " + target).green);
        });
      }
    };

    Compiler.prototype.compile_jade = function(after_compile) {
      var buffer, compiled, file, files, folder, name, output, source, _i, _len;
    ...
    Compiler.prototype.compile = function() {
      ...
      return this.compile_stylus(function(css) {
        ...
        target = "" + _this.the.pwd + "/public/app.css";
        fs.writeFileSync(target, css);
        return console.log(("" + 'Compiled'.bold + " " + target).green);
      });
    };
