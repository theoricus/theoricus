...
(function() {
  ...
  theoricus.commands.Compiler = (function() {
    ...
    function Compiler(the, options) {
      ...
      config = {
        folders: {},
        vendors: ["" + this.the.root + "/www/vendors/JSON-js/json2.js", "" + this.the.root + "/www/vendors/history.js/scripts/bundled/html4+html5/native.history.js", "" + this.the.root + "/www/vendors/jade/runtime.js", "" + this.the.root + "/www/vendors/jquery.js"],
        minify: false,
