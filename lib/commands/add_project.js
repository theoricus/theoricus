...
(function() {
  ...
  module.exports = AddProject = (function() {
    ...
    AddProject.prototype.configure = function() {
      var branch, clone, deps, name, options, params, repo, the_bin, the_www,
        _this = this;
        ...
        clone.on('close', function(code) {
          ...
          return checkout.on('close', function(code) {
            ...
            return install.on('close', function(code) {
              return _this.write_config(name, deps, the_www, the_bin);
            });
          });
        });
        return;
      ...
      return this.write_config(name, deps, the_www, the_bin);
    };

    AddProject.prototype.write_config = function(name, deps, the_www, the_bin) {
      var make, pack, polvo;
      ...
      make = path.join(this.the.root, 'cli', 'templates', 'config', 'makefile');
      ...
      fs.writeFileSync(path.join(this.target, 'makefile'), make);
      return this.finish();
    };
