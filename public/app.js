...
var data,a,div,footer,h1,head,header,i,th,u, p;a = function(){return __ck.tag('a', arguments);};div = function(){return __ck.tag('div', arguments);};footer = function(){return __ck.tag('footer', arguments);};h1 = function(){return __ck.tag('h1', arguments);};head = function(){return __ck.tag('head', arguments);};header = function(){return __ck.tag('header', arguments);};i = function(){return __ck.tag('i', arguments);};th = function(){return __ck.tag('th', arguments);};u = function(){return __ck.tag('u', arguments);};p = function(){return __ck.tag('p', arguments);};var __slice = Array.prototype.slice;var __hasProp = Object.prototype.hasOwnProperty;var __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };var __extends = function(child, parent) {  for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; }  function ctor() { this.constructor = child; }  ctor.prototype = parent.prototype; child.prototype = new ctor; child.__super__ = parent.prototype;  return child; };var __indexOf = Array.prototype.indexOf || function(item) {  for (var i = 0, l = this.length; i < l; i++) {    if (this[i] === item) return i;  } return -1; };
  ...
  */
  ...
  __t('theoricus.core').Router = (function() {
    ...
    function Router(the, on_change) {
      ...
      for (route in _ref) {
        opts = _ref[route];
        this.map(route, opts.to, opts.at);
      }
    ...
    Router.prototype.navigate = function(url, trigger, replace) {
      ...
      if (this.the.boot.no_push_state) {
  ...
  __t('theoricus.core').Processes = (function() {
    ...
    function Processes(the) {
      ...
      Factory = this.the.factory;
      if (this.the.boot.animate_at_startup === false) {
        this.disable_transitions = this.the.boot.disable_transitions;
        this.the.boot.disable_transitions = true;
      }
    ...
    Processes.prototype._run_pending_processes = function() {
      ...
      if (this.pending_processes.length) {
        ...
        if (this.disable_transitions != null) {
          this.the.boot.disable_transitions = this.disable_transitions;
  ...
  __t('theoricus.mvc').View = (function() {
    ...
    View.prototype["in"] = function(after_in) {
      var _this = this;
      if (!this.the.boot.enable_auto_transitions || this.the.boot.disable_transitions) {
  ...
  __t('theoricus').Theoricus = (function() {
    ...
    function Theoricus(boot) {
      this.boot = boot;
      this.boot.name = "app";
      this.boot.no_push_state = typeof history.pushState === !'function';
      this.boot.disable_transitions = this.boot.no_push_state || /(\?|\&)(crawler)/.test(window.location);
  ...
  __t('app.controllers').HomeController = (function(_super) {
  ...
  __t('app.models').HomeModel = (function(_super) {
  ...
  __t('app.models').MainModel = (function(_super) {
    ...
    MainModel.prototype.lines = [5, 4, 3, 2, 1];
  ...
  __t('app.views.main').MainView = (function(_super) {
    ...
    MainView.prototype.set_triggers = function() {
      ...
      return this.el.find("a").click(function(ev) {
        ...
        if (!_this.the.boot.no_push_state) {
